...
vSOC.lo(v,t,a) = 0.0*vNum(v,a)*vBattery(v);
vSOC.up(v,t,a) = 1.0*vNum(v,a)*vBattery(v);
...
SUPPLY(t) $(ord(t) gt 1) ..                 loadTCR1(t)+ loadTCR2(t)+loadTCR3(t)+loadTCR4(t)+loadTCR5(t) =e= sum(g, gLevel(g,t))+sum(s,sDischarge(s,t)-sCharge(s,t))+wind(t)-sum((v,a),vCharge(v,t,a));
...
VFULLYCHARGE(v,t,a)$fct(v,t)..               vSOC(v,t,a) =e= 1.0*vNum(v,a)*vBattery(v);
